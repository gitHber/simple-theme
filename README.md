...
**simple-theme is a responsive blog theme for Hexo which include day night model,insight search,article view count etc. Inspired by JianShu.com**.
...
## Installation
 ...
 Modify `theme` setting in `_config.yml` to `simple-theme`.
...
For a quick start, see my [Site backup](https://githber.github.io/) may be more convenient.
